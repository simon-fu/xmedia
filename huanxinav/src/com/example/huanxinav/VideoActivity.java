...
//	static String remote_addr = "192.168.2.111"; // note3
	static String remote_addr = "192.168.2.100"; // xiaomi
	
	//static String remote_addr = "203.195.185.236";//
//	static String remote_addr = "10.0.1.128";//
//	static String remote_addr = "192.168.23.2";//
	//static int vplayport = 9000;
	static int vplayport = 9800;
	static int vcaptureport = 10000;
	//int aport = 5000;
	int aport = 9900;  
	static String cid = "confId001";
...
//	static int bitrate = 384;
 	        ...
 	        if (mCamera == null) {
 	        	...
 	        	if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
 	        		   for (int i = 0; i <camera_count;  i++) {
 	        		    ...
 	        		    if (info.facing == CameraInfo.CAMERA_FACING_FRONT) {//find front camera
    ...
    protected void onDestroy() {
        ...
        Log.e("SDL","to stop video");
        nativeAgt.nativeStopVideo();
        Log.e("SDL","Have stop video");
...
class SDLMain implements Runnable {
    public void run() {
    	...
    	VideoActivity.nativeAgt.nativeStartVideo(VideoActivity.vplayport, 
    			                                 VideoActivity.vplayport, 
    			                                 VideoActivity.remote_addr,
    			                                 VideoActivity.cid, 
    			                                 VideoActivity.channelm,
    			                                 VideoActivity.password,
    			                                 /*VideoActivity.mwidth,
    			                                 VideoActivity.mheight,*/
    			                                 VideoActivity.mheight,
    			                                 VideoActivity.mwidth,
    			                                 VideoActivity.bitrate);
