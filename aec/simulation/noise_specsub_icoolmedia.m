%  refer http://blog.csdn.net/leixiaohua1020/article/details/47276353

% function noise_specsub_icoolmedia()
%     specsub('voice_noise.wav', 'out.wav');
%     return;
