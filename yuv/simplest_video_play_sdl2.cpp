...
// static int pixel_w=320,pixel_h=180;
// unsigned char buffer[pixel_w*pixel_h*bpp/8];
// //BPP=32
// unsigned char buffer_convert[pixel_w*pixel_h*4];

// by simon
#define FILENAME "CiscoVT2people_320x192_12fps.yuv"
static int pixel_w=320,pixel_h=192;
static unsigned char buffer[1024*1024];
static unsigned char buffer_convert[1024*1024];
